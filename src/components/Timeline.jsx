...
const EVENTS = [
  ...
  },
  {
    ...
    desc: 'Nervous hearts, wide smiles, and a conversation that never wanted to end. That night I drove home thinking only of when I\'d see you again.',
    side: 'right',
  },
  {
    icon: '💕',
  ...
  },
  {
    icon: '🌍',
    period: 'All the Days',
    title: 'Adventures & Everything In Between',
    desc: 'Every trip, every lazy Sunday, every inside joke, every shared meal. You make even the most ordinary moments feel like the greatest privilege.',
    side: 'right',
  },
  {
    icon: '🎂',
